...
public class DictionaryTest 
{
	...
	BST bst = new BST("C:\\Users\\admin\\workspace\\dictionary\\src\\dictionary\\map.json");
	
	@Test
	public void testGetSortedList()
	{
		String expected = "[1 : chandler, 2 : monica, 3 : rachel, 4 : joey, 5 : phoebe, city : London, first name : ross, mobile : 1234566789, name : John]";
	...
	public void testGetSortedListBoundKey() 
	{
		...
		String exp2="[1 : chandler, 2 : monica, 3 : rachel, 4 : joey, 5 : phoebe, city : London, first name : ross, mobile : 1234566789]";
		String exp3 ="[4 : joey, 5 : phoebe, city : London]";
		String exp4 = "[city : London, first name : ross, mobile : 847339282, name : John]";
		String exp5 = "[3 : rachel, 4 : joey, 5 : phoebe, city : London, first name : ross, mobile : 1234566789]";
